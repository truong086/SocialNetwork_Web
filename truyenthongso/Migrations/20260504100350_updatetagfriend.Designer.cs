...
namespace truyenthongso.Migrations
{
    ...
    [Migration("20260504100350_updatetagfriend")]
    partial class updatetagfriend
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("truyenthongso.Models.Tag_Friend", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("truyenthongso.Models.Tag_Friend", b =>
                {
                    b.HasOne("truyenthongso.Models.User", "friend")
                        .WithMany("friends")
                        .HasForeignKey("friend_id")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("truyenthongso.Models.Post", "post")
                        .WithMany("tag_Friends")
                        .HasForeignKey("postid");
